 ...
 *
 * This endpoint allows you to manually trigger a Zora Content Coin creation.
 ...
 *
 * Example:
 * /api/cron/zora-manual?date=2009-01-03&slot=0&secret=YOUR_SECRET
 *
 * WARNING: This WILL create a coin on Zora (Base mainnet)! Use for testing only.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await postEventToZora(event, dateParam, slotIndex);
    ...
    console.error("Manual Zora post error:", error);
    return NextResponse.json(
      {
