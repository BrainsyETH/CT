...
VALUES (
  ...
  '[{"type":"twitter","twitter":{"tweet_url":"https://x.com/ChristiesInc/status/1362381219816742916","account_handle":"ChristiesInc"}}]'::jsonb,
  ...
  '{"btc_price_usd": 52000, "eth_price_usd": 1900, "beeple_final_sale_usd": 69300000}'::jsonb
);
...
VALUES (
  ...
  '{"timeline"}',
  '',
  '[{"type":"twitter","twitter":{"tweet_url":"https://x.com/AshCrypto/status/1891882145632694330","account_handle":"AshCrypto"}}]'::jsonb,
  '[{"label":"FTX Recovery Plan","url":"https://restructuring.ra.kroll.com/FTX"}]'::jsonb,
  '{"initial_distribution_usd": 1200000000, "total_planned_usd": 16000000000}'::jsonb
);
